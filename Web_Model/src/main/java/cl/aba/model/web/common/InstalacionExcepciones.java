...
/**
 * InstalacionExcepciones generated by hbm2java
 */
public class InstalacionExcepciones  implements java.io.Serializable {
    ...
    public InstalacionExcepciones(int instalacionExcepcionId, Date fechaInicioFe, Date fechaTerminoFe, Date fechaCreacionFe, Boolean esPago, String comentario, Set instalacioneses) {
       this.instalacionExcepcionId = instalacionExcepcionId;
